  ...
  return (
    <div className="flex items-center justify-end ">
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[100vw] max-h-[90vh] overflow-y-auto  p-6 bg-background shadow-lg rounded-lg">
          <DialogHeader>
                              ...
                              return (
                                <div key={objectId} className="p-3 border rounded-md bg-background">
                                  <div className="flex justify-between items-center mb-2">
                                    ...
                                    <Badge className="text-xs w-[160px]">
                                      {object?.objectName}
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex-1 p-4 bg-muted/20 rounded-md ">
                            <div className="flex items-center justify-between mb-3">
                              <h4 className="text-sm font-medium">Objets disponibles</h4>
                              <Input
