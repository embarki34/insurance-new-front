...
function SupremeCourt({ SupremeCourt, onAdd, case_id, caseType, events }: { SupremeCourt: any[], onAdd: () => void, case_id: string, caseType: string, events: event[] }) {
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className="flex items-center gap-0.5">
                    ...
                    <h2 className="text-2xl font-bold flex items-center gap-2">
                        قضايا علي مستوى المحاكم العليا
                    </h2>
                </div>
                {SupremeCourt.length < 1 && <AddJudicialCouncil
                    case_id={case_id}
                    onAdd={onAdd}
